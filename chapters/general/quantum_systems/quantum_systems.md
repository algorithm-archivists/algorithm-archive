...
This means that we can ultimately move between real and momentum space by using [Fourier Transforms](../../cooley_turkey/cooley_tukey.md), which is incredibly useful in a number of cases!
