...
Note that the this project is (by its nature) collaborative, but is essentially a book about algorithms. 
...
Hopefully, this project will grow and allow individuals to learn about and try their hand at implementing different algoroithms for fun and (potentially) useful projects.
