...
{% sample lang="golang" %}
[import:5-16, lang:"Golang"](code/golang/verlet.go)
{% endmethod %}
...
{% sample lang="golang" %}
[import:18-30, lang:"Golang"](code/golang/verlet.go)
{% endmethod %}
...
{% sample lang="golang" %}
[import:32-42, lang:"Golang"](code/golang/verlet.go)
{% endmethod %}
...
{% sample lang="golang" %}
[import, lang:"Golang"](code/golang/verlet.go)
{% endmethod %}
