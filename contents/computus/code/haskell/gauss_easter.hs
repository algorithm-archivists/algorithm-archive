...
main :: IO ()
main = do
  let years = [2020 .. 2030] :: [Int]
      servoisNumbers = map (computus Servois) years :: [String]
      easterDates = map (computus Easter) years :: [String]
