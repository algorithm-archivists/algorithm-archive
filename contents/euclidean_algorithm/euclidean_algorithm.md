...
{% sample lang="perl" %}
[import:5-19, lang="perl"](code/perl/euclidean_example.pl)
{% endmethod %}
...
{% sample lang="perl" %}
[import:21-33, lang="perl"](code/perl/euclidean_example.pl)
{% endmethod %}
...
{% sample lang="perl" %}
[import, lang="perl"](code/perl/euclidean_example.pl)
{% endmethod %}
